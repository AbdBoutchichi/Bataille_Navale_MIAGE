        ...
        while (bat !=0) {
            ...
            if (brd.joueur1.out((int)lecteur.charAt(0)-48, brd.convertPos(lecteur.charAt(1)),dim,lecteur.charAt(2), brd.dimension)) {
                ...
                if(bat == 5){
                    ...
                    dim = 5;
                    brd.joueur1.placeBateau((int)lecteur.charAt(0)-48, brd.convertPos(lecteur.charAt(1)),lecteur.charAt(2),dim,"Porte-avions");
                    bat--;
                } else if (bat == 4) {
                    System.out.println("\n\nOù poser le Croiseur (longueur = 4)?");
                    dim = 4;
                    brd.joueur1.placeBateau((int)lecteur.charAt(0)-48, brd.convertPos(lecteur.charAt(1)),lecteur.charAt(2),dim,"Croiseur");
                    bat--;
                } else if (bat == 2 || bat == 3) {
                    System.out.println("\n\nOù poser le Contre-torpilleur (longueur = 4)?");
                    dim = 3;
                    brd.joueur1.placeBateau((int)lecteur.charAt(0)-48, brd.convertPos(lecteur.charAt(1)),lecteur.charAt(2),dim,"Contre-torpilleur");
                    bat--;
                } else {
                    System.out.println("\n\nOù poser le Torpilleur (longueur = 4)?");
                    dim = 2;
                    brd.joueur1.placeBateau((int)lecteur.charAt(0)-48, brd.convertPos(lecteur.charAt(1)),lecteur.charAt(2),dim,"Torpilleur");
                    bat--;
                }
            }
            dim--;
        ...
        while (bat !=0) {
            ...
            if (brd.joueur2.over((int)lecteur.charAt(0)-49, brd.convertPos(lecteur.charAt(1)),dim,lecteur.charAt(2)) || brd.joueur2.out((int)lecteur.charAt(0)-48, brd.convertPos(lecteur.charAt(1)),dim,lecteur.charAt(2), 10)) {
                ...
                if(bat == 5){
                    System.out.println("\n\nOù poser le Croiseur (longueur = 4)?");
                    dim = 5;
                    brd.joueur2.placeBateau((int)lecteur.charAt(0)-48, brd.convertPos(lecteur.charAt(1)),lecteur.charAt(2),dim,"Porte-avions");
                    bat--;
                } else if (bat == 4) {
                    System.out.println("\n\nOù poser le Contre-torpilleur (longueur = 3)?");
                    dim = 4;
                    brd.joueur2.placeBateau((int)lecteur.charAt(0)-48, brd.convertPos(lecteur.charAt(1)),lecteur.charAt(2),dim,"Croiseur");
                    bat--;
                } else if (bat == 2 || bat == 3) {
                    System.out.println("\n\nOù poser le Torpilleur (longueur = 2)?");
                    dim = 3;
                    brd.joueur2.placeBateau((int)lecteur.charAt(0)-48, brd.convertPos(lecteur.charAt(1)),lecteur.charAt(2),dim,"Contre-torpilleur");
                    bat--;
                } else {
                    
                    dim = 2;
                    brd.joueur2.placeBateau((int)lecteur.charAt(0)-48, brd.convertPos(lecteur.charAt(1)),lecteur.charAt(2),dim,"Torpilleur");
                    bat--;
                }
            }
            dim--;
